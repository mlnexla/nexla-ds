...
interface FiRrInfinityProps {
  className?: string;
  size?: number;
  color?: string;
}

const FiRrInfinity: React.FC<FiRrInfinityProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
