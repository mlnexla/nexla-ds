...
interface FiRrFilmProps {
  className?: string;
  size?: number;
  color?: string;
}

const FiRrFilm: React.FC<FiRrFilmProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
