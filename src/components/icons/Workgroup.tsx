...
<path d="M3.06067 13.8016C3.05489 13.6684 3.052 13.5353 3.052 13.4027C3.052 9.89722 5.00679 6.85524 7.87019 5.33972" stroke={color} strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M16.8108 21.0651C15.4213 21.9661 13.7711 22.4884 12.0001 22.4884C10.2291 22.4884 8.57838 21.9661 7.18945 21.0651" stroke={color} strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M16.1309 5.33972C18.9943 6.85524 20.9491 9.89722 20.9491 13.4027C20.9491 13.5364 20.9462 13.669 20.9404 13.8016" stroke={color} strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
};
