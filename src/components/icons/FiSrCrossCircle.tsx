...
interface FiSrCrossCircleProps {
  className?: string;
  size?: number;
  color?: string;
}

const FiSrCrossCircle: React.FC<FiSrCrossCircleProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
...
export default FiSrCrossCircle;