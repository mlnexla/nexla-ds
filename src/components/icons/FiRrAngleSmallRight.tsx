...
interface FiRrAngleSmallRightProps {
  className?: string;
  size?: number;
  color?: string;
}

const FiRrAngleSmallRight: React.FC<FiRrAngleSmallRightProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
