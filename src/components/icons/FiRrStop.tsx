...
interface FiRrStopProps {
  className?: string;
  size?: number;
  color?: string;
}

const FiRrStop: React.FC<FiRrStopProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
