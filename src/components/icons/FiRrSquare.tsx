...
interface FiRrSquareProps {
  className?: string;
  size?: number;
  color?: string;
}

const FiRrSquare: React.FC<FiRrSquareProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
