...
interface FiRrGridAltProps {
  className?: string;
  size?: number;
  color?: string;
}

const FiRrGridAlt: React.FC<FiRrGridAltProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
