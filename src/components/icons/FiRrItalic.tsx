...
interface FiRrItalicProps {
  className?: string;
  size?: number;
  color?: string;
}

const FiRrItalic: React.FC<FiRrItalicProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
